...
int main()
{
    ...
    output_9162022 << "Tony"
           ...
           << "D"
           << " "
           << "Daniels" <<" "<< 90 << std::endl; // im using output (The variable name I made) as cout
                                            // the only reason why i cn do that is because its coming from ofstream
                                            // another type of stream output
    output_9162022.close();
    //every time I run this code, whatever is in the code itself will be written to scores.txt.. freakin dope
